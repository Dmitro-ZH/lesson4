# class superhero:
#     count_super = 0
#     def __init__(self, height=190, power=1000, wisdom=1000):
#         self.height = height
#         superhero.count_super += 1
#         self.power = power
#         self.wisdom = wisdom
#
# captain_america = superhero(power=1500)
# spiderman = superhero(height=180, power=900)
# dima = superhero(height=200, power=15, wisdom=9999)
#
# print(f"{captain_america.height}\n{spiderman.height}\n{superhero.count_super}\n{captain_america.power}\n{spiderman.power}")
#
